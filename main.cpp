...
int search(int threadNum, int outputInfo, int start, int end, int opStart, int opSteps, int isRight, 
	...
	for (int i = 0; i < diff.size(); i++)
		cout << setw(2) << start - 5 + i << " " << diff[i] << endl;
	cout << endl;
...
int main() {
	...
	cout << "Do you allow the solver to output the solving process? (1 / 0) - (allowed / not allowed):";
	cin >> outputInfo;
	if (outputInfo != 0)
		outputInfo = 1;

	//efficiently check some examples for better understanding the usage of the code
	...
	//searchTrail(threadNum, outputInfo, "data/right/test1_msgFile.txt", "data/right/test1_diffFile.txt", "data/right/test1_parFile.txt");
	//searchTrail(threadNum, outputInfo, "data/right/test2_msgFile.txt", "data/right/test2_diffFile.txt", "data/right/test2_parFile.txt");
	//searchTrail(threadNum, outputInfo, "data/right/test3_msgFile.txt", "data/right/test3_diffFile.txt", "data/right/test3_parFile.txt");
